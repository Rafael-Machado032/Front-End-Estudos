...
export default function Hero() {
  return (
    <article className='flex justify-between w-full max-w-4xl mx-auto py-10 gap-4 lg:flex-row'>
      <div className='w-full gap-4 flex flex-col text-center items-center lg:w-1/2 lg:text-start'>
        ...
        <form className='w-full flex flex-col justify-center items-center gap-2 md:flex-row'>
      ...
      <div className='hidden grid-cols-2 grid-rows-[repeat(2,min-content)] w-fit h-fit gap-4 lg:grid'>
